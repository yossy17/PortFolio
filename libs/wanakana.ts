...
//     console.log('API call skipped for development');
//     return text;
//   }
...
//       console.error('Error converting kanji to hiragana:', error.response?.data || error.message);
//     } else {
...
//     return segment.toLowerCase(); // エラーの場合は小文字に変換して返す
//   }
// }
...
//     return title.toLowerCase().replace(/\s+/g, '-').slice(0, 30); // エラーの場合は簡易的なスラグを生成
//   }
// }
